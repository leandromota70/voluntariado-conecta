                    ...
                    <div class="bg-white rounded-lg shadow overflow-hidden mb-8">
                        ...
                        <div class="divide-y divide-gray-200">
                            <div class="p-6 hover:bg-gray-50">
                                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                    <div class="mb-4 md:mb-0">
                                        <h3 class="text-lg font-medium text-indigo-600">Apoio Escolar para Crianças</h3>
                                        <div class="flex items-center mt-2 text-gray-600">
                                            <i data-feather="map-pin" class="mr-2 w-4 h-4"></i>
                                            <span>São Paulo, SP</span>
                                            <i data-feather="calendar" class="ml-4 mr-2 w-4 h-4"></i>
                                            <span>Segundas e Quartas, 14h-17h</span>
                                        </div>
                                    </div>
                            ...
                            <div class="p-6 hover:bg-gray-50">
                                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                    <div class="mb-4 md:mb-0">
                                        <h3 class="text-lg font-medium text-indigo-600">Arborização Urbana</h3>
                                        <div class="flex items-center mt-2 text-gray-600">
                                            <i data-feather="map-pin" class="mr-2 w-4 h-4"></i>
                        ...
                        <div class="px-6 py-4 border-t border-gray-200 text-center">
                            <a href="#" class="text-indigo-600 hover:text-indigo-900 font-medium">Ver todas as vagas</a>
                        </div>
                    </div>
